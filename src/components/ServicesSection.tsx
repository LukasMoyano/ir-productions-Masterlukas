      ...
      services: [
        {
          ...
          description: "We democratise agricultural technology with practical workshops that fuse ancestral wisdom and modern digital tools.",
          benefits: ["Practical training", "Accessible technology", "Social impact"],
          image: agroTechImage,
          badge: "Education",
          color: "agro-green"
        },
        {
          ...
          description: "Custom-built high-performance AMD workstations for artificial intelligence, rendering and scientific computing.",
          benefits: ["Premium hardware", "AI optimisation", "Technical support"],
          image: hpcWorkstationImage,
          badge: "Hardware",
          color: "primary"
        },
        {
          ...
          description: "Autonomous AI-powered robot for agricultural monitoring, crop optimisation and real-time environmental data collection.",
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="text-center mt-16">
          ...
          <Button 
            ...
            onClick={() => document.getElementById(language === 'es' ? 'contacto' : 'contact')?.scrollIntoView({ behavior: 'smooth' })}
          >
            {language === 'es' ? 'Solicita una Consulta Gratuita' : 'Request a Free Consultation'}
