...
export default {
	darkMode: ["class"],
	content: [
		"/mnt/Proyectos4TB/backup_masterlukas/Documents/_-IR_Productions_2025/WwW_EndesarrolloWEB/ir-productions-nexus-main/frontend/src/**/*.{js,ts,jsx,tsx}",
		"./index.html",
